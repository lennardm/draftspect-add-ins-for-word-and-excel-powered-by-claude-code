...
- **Commit directly to main.** Per the user's standing preference (updated 2026-05-28), work is committed straight to `main` — no feature-branch-and-PR workflow and no PRs. This is the user's own independent repo, so the PR ceremony isn't needed. See `feedback_commit_directly_to_main`.
